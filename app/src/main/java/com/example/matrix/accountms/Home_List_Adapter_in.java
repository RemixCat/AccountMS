...
public class Home_List_Adapter_in extends BaseAdapter {
    ...
    public Home_List_Adapter_in(List<Map<String,Object>> mData,Context context)
    {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null)
        {
            ...
            list_data.list_cont = (TextView) convertView.findViewById(R.id.list_cont);
            list_data.list_date = (TextView)convertView.findViewById(R.id.list_date);
